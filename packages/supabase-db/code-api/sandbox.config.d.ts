 ...
 */
export declare function isModuleAllowed(modulePath: string, config?: SandboxConfig): boolean;
/**
 * Check if operation is allowed
 */
export declare function isOperationAllowed(operation: 'read' | 'write' | 'admin', config?: SandboxConfig): boolean;
/**
