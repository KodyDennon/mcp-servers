...
import { connectToDatabaseTool, listConnectionsTool, switchConnectionTool, handleConnectionToolCall, } from "./tools/connectionTools.js";
import { queryTool, queryTransactionTool, explainQueryTool, handleQueryToolCall, } from "./tools/queryTools.js";
import { listTablesTool, getTableSchemaTool, listIndexesTool, listFunctionsTool, searchSchemaTool, createTableTool, dropTableTool, addColumnTool, dropColumnTool, createIndexTool, diffSchemaTool, handleSchemaToolCall, } from "./tools/schemaTools.js";
import { runMigrationTool, listMigrationsTool, generateMigrationTool, seedDataTool, handleMigrationToolCall, } from "./tools/migrationTools.js";
import { importDataTool, insertRowTool, updateRowTool, deleteRowTool, handleDataToolCall, } from "./tools/dataTools.js";
import { getDatabaseStatsTool, createBackupTool, manageAuthTool, manageStorageTool, handleAdminToolCall, } from "./tools/adminTools.js";
import { subscribeTool, handleSubscriptionToolCall, } from "./tools/subscriptionTools.js";
import { deployFunctionTool, listFunctionsTool as listEdgeFunctionsTool, deleteFunctionTool, handleEdgeFunctionToolCall, } from "./tools/edgeFunctionTools.js";
import { rag, indexDirectory, indexUrl } from "./tools/aiTools.js";
import { healthCheckTool, getConnectionStatsTool, getRecoveryStatsTool, resetCircuitBreakerTool, handleMonitoringToolCall, } from "./tools/monitoringTools.js";
import { getCacheStatsTool, clearCacheTool, listTemplatesTool, getTemplateTool, executeTemplateTool, getHelpTool, searchHelpTool, startTourTool, getRateLimitsTool, setClientTierTool, registerTenantTool, listTenantsTool, listPluginsTool, enablePluginTool, disablePluginTool, getMetricsTool, analyzeQueryTool, getOptimizationReportTool, handleAdvancedToolCall, } from "./tools/advancedTools.js";
/**
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        try {
            ...
            if ([rag.name, indexDirectory.name, indexUrl.name].includes(name)) {
                if (!process.env.OPENAI_API_KEY) {
                    throw new Error(`Tool '${name}' requires OPENAI_API_KEY environment variable to be set. AI/RAG tools are optional and only needed for embeddings and semantic search features.`);
                }
