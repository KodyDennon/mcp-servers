...
import {
  getSandboxConfig,
  getExecutionMode,
} from "./code-api/sandbox.config.js";
/**
      ...
      tools: [
        {
          name: "code_execution",
          description:
            "Execute code that uses the Supabase DB API. Import from './servers/supabase-db/' to access database operations.",
          input_schema: {
            type: "object",
            properties: {
              code: {
        ...
        },
        {
          ...
          description:
            "Get current code execution mode configuration (sandbox vs direct)",
          input_schema: {
            type: "object",
            properties: {},
          },
        ...
        content: [
          {
            ...
            text: JSON.stringify(
              {
                error:
                  "Code execution not implemented in this runtime. Use a sandbox environment that supports code execution mode.",
              },
              null,
              2,
            ),
