...
export const getDatabaseStatsTool = {
  ...
  description:
    "Get database statistics including size, connection count, and performance metrics.",
...
export const createBackupTool = {
  ...
  input_schema: z.object({
    filename: z
      ...
      .optional()
      .describe(
        "Output filename for the backup (default: backup_TIMESTAMP.sql)",
      ),
    tables: z
      .array(z.string())
      .optional()
      .describe("Optional: specific tables to backup (defaults to all)"),
  }),
  output_schema: z.object({
    path: z.string(),
    filename: z.string(),
