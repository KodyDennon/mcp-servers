...
export const deployFunctionTool = {
  ...
  input_schema: z.object({
    ...
    functionCode: z
      .string()
      .describe("The JavaScript/TypeScript code for the function."),
  }),
...
export async function handleEdgeFunctionToolCall(toolName, input) {
  if (!process.env.SUPABASE_ACCESS_TOKEN || !process.env.SUPABASE_PROJECT_ID) {
    throw new Error(
      "SUPABASE_ACCESS_TOKEN and SUPABASE_PROJECT_ID environment variables are required for this tool.",
    );
  }
  try {
    switch (toolName) {
...
//# sourceMappingURL=edgeFunctionTools.js.map
