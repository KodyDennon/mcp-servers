...
export const subscribeTool = {
  ...
  input_schema: z.object({
    ...
    event: z
      ...
      .describe("The type of event to subscribe to.")
      .default("*"),
    callbackUrl: z
      .string()
      .url()
      .describe("The URL to send notifications to when an event occurs."),
  }),
    ...
    switch (toolName) {
      case subscribeTool.name: {
        ...
        channel
          ...
          .subscribe();
        return {
          message: `Subscribed to ${event} events on table ${tableName}. Notifications will be sent to ${callbackUrl}`,
        };
      }
      default:
