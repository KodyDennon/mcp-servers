...
export declare class SimctlCommandError extends Error {
    ...
    constructor(message: string, command: string[], stdout: string, stderr: string, exitCode?: number | null | undefined);
}
export declare class Simctl {
    ...
    takeScreenshot(udid: string | "booted", outputPath: string, format?: "png" | "jpg"): Promise<void>;
    recordVideo(udid: string | "booted", outputPath: string, options?: {
        timeLimit?: number;
    }): Promise<void>;
