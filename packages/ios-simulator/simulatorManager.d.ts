...
export declare class SimulatorManager {
    ...
    captureScreenshot(query?: string, format?: "png" | "jpg"): Promise<ScreenshotResult>;
    installApp(appPath: string, query?: string): Promise<{
        device: SimulatorDevice;
        appPath: string;
    }>;
    uninstallApp(bundleId: string, query?: string): Promise<{
        device: SimulatorDevice;
        bundleId: string;
    }>;
    launchApp(bundleId: string, query?: string, args?: string[]): Promise<{
        device: SimulatorDevice;
        bundleId: string;
        output: string;
    }>;
    terminateApp(bundleId: string, query?: string): Promise<{
        device: SimulatorDevice;
        bundleId: string;
    }>;
}
