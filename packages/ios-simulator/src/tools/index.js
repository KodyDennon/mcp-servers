import { bootSimulatorTool, handleSimulatorToolCall, listSimulatorsTool, openUrlTool, screenshotTool, shutdownSimulatorTool, } from "./simulatorTools.js";
import { captureInspectorScreenshotTool, evaluateJavaScriptTool, handleInspectorToolCall, listInspectorTargetsTool, } from "./inspectorTools.js";
import { handleAutomationToolCall, installAppTool, uninstallAppTool, launchAppTool, terminateAppTool, tapTool, swipeTool, typeTextTool, pressButtonTool, hierarchyTool, } from "./automationTools.js";
