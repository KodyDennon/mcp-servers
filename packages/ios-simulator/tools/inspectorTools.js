...
export const listInspectorTargetsTool = {
    ...
    description: "Enumerate the inspectable Safari tabs/webviews exposed by the simulator via the WebKit remote debugging protocol.",
    input_schema: z
        .object({
...
export const evaluateJavaScriptTool = {
    ...
    description: "Run JavaScript inside the selected Safari webview by leveraging the WebKit DevTools protocol. Great for DOM inspection or simple smoke tests.",
    input_schema: z
        .object({
        targetId: z
            .string()
        ...
        expression: z
            .string()
            .describe("JavaScript expression to evaluate (for example `document.title`)."),
...
export const captureInspectorScreenshotTool = {
    ...
    description: "Capture a page screenshot using the WebKit DevTools Page.captureScreenshot endpoint. Requires an inspectable Safari target.",
    input_schema: z
        .object({
        targetId: z.string(),
        device: z.string().optional(),
