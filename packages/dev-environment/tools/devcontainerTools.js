    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          runtime: {
            type: "string",
            description: "Runtime type: node, python, ruby, etc.",
          },
...
export async function handleDevContainerToolCall(name, args) {
  switch (name) {
    ...
    case "devcontainer_generate_config": {
      const { directory, runtime, version = "latest" } = args;
      const configs = {
        node: {
...
//# sourceMappingURL=devcontainerTools.js.map
